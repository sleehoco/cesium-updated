          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-white font-display">
                Threat Intelligence <span className="text-sky-400">Analyzer</span>
              </h1>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <Card className="bg-navy-800 border-navy-700 mb-8">
            ...
            <CardContent className="space-y-4">
              <Textarea
                ...
                className="min-h-[100px] bg-navy-900 border-navy-700 text-white placeholder:text-gray-500 rounded-lg"
                disabled={loading}
              />
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-400">
                    Powered by <span className="text-sky-400 font-semibold">{result.provider}</span>
                  </div>
                </div>
                  ...
                  <div className="bg-navy-900 p-6 rounded-lg border border-navy-700">
                    <ReactMarkdown
                      components={{
                        ...
                        h3: ({ children }) => <h3 className="text-lg font-bold text-sky-400 mb-2">{children}</h3>,
                        p: ({ children }) => <p className="text-gray-300 mb-3 leading-relaxed">{children}</p>,
                        ul: ({ children }) => <ul className="list-disc list-inside text-gray-300 mb-3 space-y-1">{children}</ul>,
                        ol: ({ children }) => <ol className="list-decimal list-inside text-gray-300 mb-3 space-y-1">{children}</ol>,
                        li: ({ children }) => <li className="text-gray-300">{children}</li>,
                        strong: ({ children }) => <strong className="text-sky-400 font-bold">{children}</strong>,
                        code: ({ children }) => (
                          <code className="bg-black/50 px-2 py-1 rounded-lg text-sky-400 text-sm">{children}</code>
                        ),
                      }}
                    >
                      {result.analysis}
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            <Card className="bg-navy-800 border-navy-700">
              ...
              <CardContent>
                <ul className="text-gray-300 text-sm space-y-2">
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> IP Addresses (IPv4/IPv6)</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Domain Names</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> File Hashes (MD5, SHA1, SHA256)</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> URLs</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Email Addresses</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-navy-800 border-navy-700">
              ...
              <CardContent>
                <ul className="text-gray-300 text-sm space-y-2">
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Threat Level Assessment</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Known Associations</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Malware Family Detection</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Threat Actor Attribution</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Recommended Actions</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-navy-800 border-navy-700">
              ...
              <CardContent>
                <ul className="text-gray-300 text-sm space-y-2">
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Real-time Analysis</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Expert-Level Insights</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Actionable Recommendations</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Context-Aware Assessment</li>
                  <li className="flex items-start gap-2"><span className="text-sky-400">&bull;</span> Continuously Updated</li>
                </ul>
              </CardContent>
            </Card>
          </div>
