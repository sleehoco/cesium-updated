...
const colorClasses: Record<string, { bg: string; border: string; text: string }> = {
    'sky-500': { bg: 'bg-sky-500/10', border: 'border-sky-500/30', text: 'text-sky-500' },
        ...
        <main>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h1 className="text-5xl lg:text-6xl font-bold text-white font-display mb-6">
                            Free AI-Powered <span className="text-sky-400">Security Tools</span>
                        </h1>
                                    ...
                                    {categoryTools.map((tool) => {
                                        ...
                                        return (
                                            <motion.div key={tool.id} variants={itemVariants}>
                                                <Card
                                                    className={`bg-navy-800 border-navy-700 h-full flex flex-col group ${isComingSoon ? 'opacity-75' : 'hover:border-sky-500/30 transition-all duration-300'
                                                        }`}
                                                >
                                                    <CardHeader>
                                                        ...
                                                        <CardTitle className="text-white text-2xl mb-2 group-hover:text-sky-400 transition-colors">
                                                            {tool.name}
                                                        </CardTitle>
                                                        <CardDescription className="text-sky-400 font-semibold text-sm mb-3">
                                                            {tool.tagline}
                                                        </CardDescription>
                                                    ...
                                                    <CardContent className="flex-1 flex flex-col justify-between">
                                                        ...
                                                        <div className="mb-6">
                                                            <h4 className="text-white font-semibold text-sm mb-3 flex items-center gap-2">
                                                                <span className="w-1 h-4 bg-sky-500"></span>
                                                                Key Features
                                                            </h4>
            ...
            <section className="bg-white py-24">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center font-display">Why AI-Powered Security?</h2>
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="text-center">
                                <h3 className="text-sky-600 font-semibold mb-2">Real-Time Analysis</h3>
                                <p className="text-slate-600 text-sm">
                                    Get instant insights powered by advanced AI models that process threats faster than traditional methods.
                                </p>
                            </div>
                            <div className="text-center">
                                <h3 className="text-sky-600 font-semibold mb-2">Intelligent Prioritization</h3>
                                <p className="text-slate-600 text-sm">
                                    AI algorithms automatically prioritize threats based on severity, context, and potential impact.
                                </p>
                            </div>
                            <div className="text-center">
                                <h3 className="text-sky-600 font-semibold mb-2">Continuous Learning</h3>
                                <p className="text-slate-600 text-sm">
