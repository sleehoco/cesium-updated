  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-cyber-dark via-cyber to-cyber-light relative overflow-hidden">
      ...
      <section className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 font-display bg-gradient-to-r from-white via-cesium to-white bg-clip-text text-transparent">
            Contact Us
          </h1>
